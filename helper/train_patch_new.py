...
from adv_patch_gen.utils.loss import MaxProbExtractor, SaliencyLoss, TotalVariationLoss, NPSLoss, GeneralProbExtractor
...
class PatchTrainer:
    ...
    def __init__(self, cfg: edict):
        ...
        self.g_loss = GeneralProbExtractor().to(self.dev)
    ...
    def train(self) -> None:
        ...
        for epoch in range(1, self.cfg.n_epochs + 1):
            ...
            for i_batch, (img_batch, lab_batch) in tqdm(enumerate(self.train_loader),
                ...
                loss = nps_loss + tv_loss + g_loss  #  + sal_loss
                ep_loss += loss
